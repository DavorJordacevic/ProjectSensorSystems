...
def draw_line(angle,color,disp=canvas):
    ...
    if a==0:
        ...
        x = y//a
    position = detected(x,y)
    pygame.draw.line(disp,color,(width/2,height/2),position,2)
...
while True:
    ...
    if p==0:
        if counter<30:
            angle_dist= [ang,randint(70,120)]
            counter+=1
        else:
            if counter<80:
                angle_dist= [ang,randint(15,50)]
                counter+=1
            else:
                if counter<150:
                    angle_dist= [ang,randint(190,250)]
                    counter+=1
                else:
                    angle_dist= [ang,randint(310,350)]
                    counter+=1
                    if counter==180:
                        p=1
    if p==1:
        if counter<30:
            angle_dist= [ang,randint(200,250)]
            counter-=1
        else:
            if counter<80:
                angle_dist= [ang,randint(70,120)]
                ...
                if counter<150:
                    angle_dist= [ang,randint(10,50)]
                    counter-=1
                else:
                    angle_dist= [ang,randint(270,350)]
                    counter-=1
